...
var url = require('url');
var Route_context = require('../contexts/Route.context.js');
var CorsHandler = require('./CorsHandler.js');
...
const httpHandler = async (req, res, appCtx) => {
    ...
    CorsHandler(req, res, appCtx.options());
    ...
    const routeCtx = Route_context(req, res, appCtx);
